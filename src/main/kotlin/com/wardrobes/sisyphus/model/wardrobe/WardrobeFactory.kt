...
object HangingWardrobeFactory : WardrobeFactory(elementFactory = HangingWardrobeElementFactory) {
    ...
    private fun createRightSide(wardrobeHeight: Float, wardrobeDepth: Float, elementHeight: Float, numberOfShelves: Int): Element = elementFactory.createLeftSide(width = wardrobeDepth, length = wardrobeHeight, height = elementHeight, numberOfShelves = numberOfShelves)
